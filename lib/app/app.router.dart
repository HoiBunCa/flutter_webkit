...
import '../ui/views/webkit_base/webkit_base_view.dart' as _i3;
...
class StackedRouterWeb extends _i6.RootStackRouter {
  ...
  final Map<String, _i6.PageFactory> pagesMap = {
    ...
    WebkitBaseViewRoute.name: (routeData) {
      return _i6.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i3.WebkitBaseView(),
      );
    },
  ...
  List<_i6.RouteConfig> get routes => [
        ...
        _i6.RouteConfig(
          WebkitBaseViewRoute.name,
          path: '/webkit-base-view',
        ),
        _i6.RouteConfig(
...
/// generated route for
/// [_i3.WebkitBaseView]
class WebkitBaseViewRoute extends _i6.PageRouteInfo<void> {
  const WebkitBaseViewRoute()
      : super(
          WebkitBaseViewRoute.name,
          path: '/webkit-base-view',
        );

  static const String name = 'WebkitBaseView';
}
...
extension RouterStateExtension on _i5.RouterService {
  ...
  Future<dynamic> navigateToWebkitBaseView(
      {void Function(_i6.NavigationFailure)? onFailure}) async {
    return navigateTo(
      const WebkitBaseViewRoute(),
      onFailure: onFailure,
  ...
  Future<dynamic> replaceWithWebkitBaseView(
      {void Function(_i6.NavigationFailure)? onFailure}) async {
    return replaceWith(
      const WebkitBaseViewRoute(),
      onFailure: onFailure,
